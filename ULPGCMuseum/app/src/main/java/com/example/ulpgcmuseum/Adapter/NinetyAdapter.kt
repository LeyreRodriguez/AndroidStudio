...
class NinetyAdapter(private val ninetyList: ArrayList<Item>, var clickListener: NinetyActivity) : RecyclerView.Adapter<NinetyAdapter.MyViewHolder>(),
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.initialize(ninetyList.get(position), clickListener)
    ...
    class MyViewHolder(itemView : View, listener : onItemClickListener) : RecyclerView.ViewHolder(itemView){
        ...
        fun initialize(item: Item, action: NinetyActivity){
            Name.text = item.Name
